...
data class VerificationResult(
    ...
    val stateOwned: Boolean? = null,
    val routeExact: Boolean? = null,
    val watchdogEnabled: Boolean? = null,
    val watchdogIntervalSeconds: Long? = null,
    val staleTimeoutSeconds: Long? = null,
    val endpointMismatchConfirmations: Long? = null,
    val lastProbe: String? = null,
    val lastDirect: String? = null,
    val failureCount: Long? = null,
    val mismatchCount: Long? = null,
    val leaseDeadline: Long? = null,
    val expired: Boolean? = null,
    val watchdogManagedPeer: String? = null,
)
